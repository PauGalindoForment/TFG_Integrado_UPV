...
ruta_caras_perfil = "C:\\NAS_PAU\\TFG\\PGA\\FotosPerfil"
ruta_dataset = "C:\\NAS_PAU\\TFG\\PGA\\Instagram"

# Extraer nombres de jugadores del dataset (por subcarpeta)
jugadores_dataset = set([
    nombre for nombre in os.listdir(ruta_dataset)
    if os.path.isdir(os.path.join(ruta_dataset, nombre))
])

# Extraer nombres de jugadores con imagen de perfil
...
# Comprobar faltantes y sobrantes
