...
ruta_archivo_origen = r'C:\\NAS_PAU\\TFG\\LIV\\LIVinformacionjugadores2024.csv'
ruta_archivo_destino = r'C:\\NAS_PAU\\TFG\\LIV\\Instagram\\insta_posts.csv'
                ...
                if 'instagram.com' in fila['Instagram']:
                    ...
                    for jugador in lista_jugadores:
                        if jugador['Instagram'] == fila['Instagram']:
                            ...
                            jugador['Menciones_Biografia'] = str(menciones)
                            break
