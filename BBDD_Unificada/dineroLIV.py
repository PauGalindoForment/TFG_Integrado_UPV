...
# 4. Crear diccionarios: nombre → dinero / torneos
...
# 5. Actualizar columnas solo si hay match
...
# 6. Mostrar jugadores del CSV que no hicieron match
