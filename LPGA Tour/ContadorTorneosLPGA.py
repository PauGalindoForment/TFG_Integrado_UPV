...
# Cargar archivos
df_torneos = pd.read_excel("Rolex_torneos_hasta_1000.xlsx")
df_jugadores = pd.read_csv("C:\\NAS_PAU\\TFG\\LPGA\\LPGA_informacionTOTAL.csv", sep=';')
...
df_final.to_excel("jugadores_con_torneos_RolexPRUEBA.xlsx", index=False)
